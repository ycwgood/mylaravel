...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <!-- 新建编辑的表单II -->
            {{ Form::open(['url' => '/case', 'class' => 'form-horizontal form-inline']) }}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        {{ Form::number('TD_money', $case->TD_money, ['class' => 'form-control col-md-8']) }}
                    </div>
                    
                    <div class="form-group col-md-4">
                        {{ Form::label('TD_post_freeze', '事后冻结', ['class' => 'control-label col-md-4']) }}
                        {{ Form::number('TD_post_freeze', $case->TD_post_freeze, ['class' => 'form-control col-md-8']) }}
                    </div>
                    
                    <div class="form-group col-md-4">
                        {{ Form::label('TD_pre_freeze', '监控冻结', ['class' => 'control-label col-md-4']) }}
                        {{ Form::number('TD_pre_freeze', $case->TD_pre_freeze, ['class' => 'form-control col-md-8']) }}
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        {{ Form::number('DD_money', $case->DD_money, ['class' => 'form-control col-md-8']) }}
                    </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-6">
                        <button type="submit" class="btn btn-default">
                            <i class="fa fa-plus"></i> {{ $case->id == 0 ? '添加' : '编辑' }}
                        </button>
                    </div>
                </div>
            {{ Form::close() }}
